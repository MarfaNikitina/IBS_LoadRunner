...
/*Correlation comment - Do not change!  Original value='010;386;12/03/2023' Name ='outboundFlight' Type ='ResponseBased'*/
	web_reg_save_param_attrib(
	...
	lr_end_transaction("FindFlightWithoutBooking", LR_AUTO);
